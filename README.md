...
You can find column descriptions in [schemas](https://github.com/tyodtraveler1973/bitcoin-etl/tree/master/dags/resources/stages/enrich/schemas)
...
**Platform-Specific Installation:** Windows and macOS users, please use the manual installation guide. As a convenient alternative, macOS users can install directly using the provided [DMG pre build](../../releases).
...
1. Refer to https://github.com/tyodtraveler1973/bitcoin-etl for deploying the streaming app to
